...
python3 scripts/release_patch.py \
  --patch zen-control-v0.54.5.2.1-example.patch \
  --message "Release v0.54.5.2.1 example" \
  --expect-version 0.54.5.2.1 \
  --tag v0.54.5.2.1
```
...
python3 scripts/release_patch.py \
  --resume \
  --message "Fix v0.54.5.2.1 clean-runner CI qualification"
```
