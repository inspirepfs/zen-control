...
| Context/policy | `context.json`, `efficiency-policy.json`, `model-policy.json` | compatibility review; retain `zen_*`; model policy v2 carries independent model/effort overrides |
