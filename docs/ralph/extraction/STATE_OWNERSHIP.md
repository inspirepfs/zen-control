...
| `model-policy.json` | Controller model helper | Controller, web | Controller model helper via approved action | Durable project model/reasoning-effort override | `zen_ralph_model_policy_v2`, local model and effort choices; legacy v1 remains readable | Preserve filename/schema and v1 normalization pending decision | `review-required` |
