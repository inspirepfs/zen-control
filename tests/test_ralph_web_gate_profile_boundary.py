...
class WebGateProfileBoundaryTests(unittest.TestCase):
    def test_web_snapshot_and_git_use_profile_metadata_and_context(self):
        ...
        with mock.patch.object(ralph_web, "ZEN_PROFILE", profile), mock.patch.object(
    ...
    def test_web_controller_invocations_and_gate_commands_use_profile_cli(self):
        ...
        ), mock.patch.object(ralph_gate, "ZEN_PROFILE", profile):
            self.assertEqual(
    ...
    def test_zen_incident_and_performance_guidance_remains_profile_owned(self):
        ...
        self.assertEqual(incident, ralph_profile.ZEN_PROFILE.guidance(ralph_profile.ZEN_PROFILE.incident_gate_guidance))
        self.assertEqual(performance, ralph_profile.ZEN_PROFILE.guidance(ralph_profile.ZEN_PROFILE.performance_gate_guidance))
