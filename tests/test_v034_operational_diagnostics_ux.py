...
class DiagnosticsIntegrationAndUxTests(unittest.TestCase):
    ...
    def test_diagnostics_assets_are_cache_busted(self):
        self.assertIn('/static/app.css?v=0.54.5', self.template)
        self.assertIn('/static/layout.css?v=0.54.5', self.template)
        self.assertIn('/static/diagnostics.css?v=0.54.5', self.template)
