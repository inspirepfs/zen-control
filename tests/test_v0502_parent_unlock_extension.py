...
class ParentUnlockExtensionIntegrationTests(unittest.TestCase):
    ...
    def test_release_version_and_pwa_assets_are_current(self):
        ...
        self.assertIn('/static/app.css?v=0.57.0', self.index)
        self.assertIn("const RELEASE = '0.57.0'", (self.root / "app/static/pwa.js").read_text())
        self.assertIn("PWA_RELEASE = \"0.57.0\"", (self.root / "app/pwa.py").read_text())
