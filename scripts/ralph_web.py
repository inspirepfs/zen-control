...
def command_for_action(payload: dict[str, Any], state: dict[str, Any]) -> CommandRequest:
    ...
    if action == "efficiency_update":
        ...
        fields = (
            ...
            ("prompt_command_budget", "--prompt-command-budget"),
            ("normal_max_commands", "--normal-max-commands"),
            ("normal_max_reported_files", "--normal-max-reported-files"),
            ("normal_max_cumulative_input", "--normal-max-cumulative-input"),
            ("normal_max_noncached_input", "--normal-max-noncached-input"),
            ("strict_multiplier", "--strict-multiplier"),
            ("relaxed_multiplier", "--relaxed-multiplier"),
...
function markEfficiencyDirty(){efficiencyDirty=true;renderText('effPolicyState','changes pending');renderClass('effPolicyState','badge warn');syncEfficiencyResetIcons();}
...
class Handler(BaseHTTPRequestHandler):
    server_version = "RALPH-Lite-Web/0.3.3"
